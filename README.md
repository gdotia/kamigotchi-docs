...
- **Building a bot, script, or tool?** [Agent Bootstrap](guidance/agent-bootstrap.md) → [Player API Index](resources/player-api/README.md)
- **Playing with an agent?** [Agent Bootstrap](guidance/agent-bootstrap.md)
